...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "RNS Music Bot")
...
SUPPORT_CHANNEL = getenv("ILA_CHANNEL", "https://t.me/ImperialLegion")
SUPPORT_GROUP = getenv("ARISTOCRAT_PH", "https://t.me/AristocratPH")
